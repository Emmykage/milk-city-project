      ...
      <section className='py-8'>
        ...
        <div className='w-[300px] '>
          ...
          <div className='pt-6'>
            ...
            <li>Key activities: Breeding high-yield dairy cows, improving milking technology, 
            expanding processing facilities</li>
            </ul>
            <h4 className='font-semibold'>
            Benefits
            </h4>
            <ul className='list-inside list-disc'>
            <li>Steady cash flow from milk sales
            </li>
            <li>Expansion opportunities in dairy products (cheese, yogurt)
            </li>
            </ul>         
        ...
        <div className='w-[300px] '>
          ...
          <div className='pt-6'>
            ...
            <li className='text-base font-medium text-gray-600'>Investment required: $X million</li>
            <li className='text-base font-medium text-gray-600'>Projected ROI: X%</li>
            <li>Key activities: Establishing breeding programs, improving farm infrastructure, 
            expanding beef market</li>
            </ul>
            <h4 className='font-semibold'>
            Benefits
            </h4>
        ...
        <div className='w-[300px] '>
          ...
          <div className='pt-6'>
            ...
            <li className='text-base font-medium text-gray-600'>Projected ROI: X%</li>
            <li>Key activities: Establishing breeding programs, improving farm infrastructure, 
            expanding market reach</li>
            </ul>
            <h4 className='font-semibold'>
            Benefits
            </h4>
            <ul className='list-inside list-disc'>
            <li>Growing market for goat milk and meat
            </li>
        ...
        <div className='w-[300px] '>
          ...
          <div className='pt-6'>
            ...
            <li className='text-base font-medium text-gray-600'>Investment required: $X million</li>
            <li className='text-base font-medium text-gray-600'>Projected ROI: X%</li>
            <li>Key activities: Enhancing breeding techniques, expanding flock, diversifying product 
            offerings (meat, wool)</li>
            </ul>
            <h4 className='font-semibold'>
            Benefits
            </h4>
            <ul className='list-inside list-disc'>
            <li>Dual revenue streams from meat and wool
            </li>
            <li>Niche market opportunities
            </li>
        ...
        <div className='w-[300px] '>
          ...
          <div className='pt-6'>
            ...
            <li className='text-base font-medium text-gray-600'>Investment required: $X million</li>
            <li className='text-base font-medium text-gray-600'>Projected ROI: X%</li>
            <li>Key activities: Implementing advanced breeding practices, improving biosecurity 
            measures, expanding processing capabilities</li>
            </ul>
            <h4 className='font-semibold'>
            Benefits
            </h4>
            <ul className='list-inside list-disc'>
            <li> High demand for pork products
            </li>
            <li> Opportunities for value-added products (sausages, bacon)
            </li>
