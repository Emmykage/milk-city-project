...
const Home = () => (
  <div className="text-xs">
    ...
    <section className="py-20 bg-gray-100">
      ...
      <div className="max-w-7xl m-auto grid lg:grid-cols-3 gap-[3%] px-3 pt-10 pb-36 md:pb-20">
        ...
        <div className="lg:px-10 px-3 flex gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm px-3 leading-6">
              Sustainable Agriculture: Many cooperatives prioritize sustainable farming practices,
        ...
        <div className="lg:px-10 px-3 flex gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm px-3 leading-6">
              High-Quality Products: Cooperatives often focus on producing high-quality meat
...
 Traceability: Products from co-ops are often more traceable, appealing to consumer who value knowing the source of their food.</p> */}
        ...
        <div className="lg:px-10 px-3 flex gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm px-3 leading-6">
              Risk Mitigation: Investing in a cooperative can diversify your investment portfolio,
...
their community-based support and focus on essential goods.
        ...
        <div className="lg:px-10 px-3 flex gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm px-3 leading-6">
              Innovative Practices: Co-ops may adopt innovative farming and production
...
co-ops have significant potential for expansion and increased market share.
        ...
        <div className="lg:px-10 px-3 flex gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm px-3 leading-6">
              Community Building: Investing in a cooperative fosters a sense of community and
...
for members and the community, enhancing local knowledge and skills.
        ...
        <div className="lg:px-10 px-3 flex gap-3">
          ...
          <div className="flex-1 ">
            ...
            <p className="text-gray-600 text-sm px-0 leading-6">
              Member Dividends: As a member of the cooperative, you might receive dividends
              based on the co-op’s profits, offering a potential return on your investment
            </p>
            {/* <p className='text-gray-600 text-sm px-0 leading-6'>
    ...
    <section>
      <div className="flex py-16 px-6 gap-5 max-w-6xl m-auto flex-col sm:flex-row">
        ...
        <div className="flex-1 flex gap-3 flex-col sm:flex-row">
          <div className="flex-1 px-4 border py-10 w-full bg-card-img text-white font-semibold">
    ...
    <section>
      <div className="max-w-6xl m-auto border p-6 flex">
        <h3 className="flex-1 text-left text-xl">
          Start Exploring High Profit Potential
          <br />
          {' '}
