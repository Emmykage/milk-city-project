...
const Portfolio = () => {
  ...
  return (
    <div className='portfolio sm:px-16'>
      ...
      <li className='relative border-b py-2'><NavLink className={({isActive}) => (isActive ? activeLink : inactiveLink)} to="/dashboard/portfolio/investments">INVESTMENTS</NavLink> </li>
